	...
	<div id="itemList">
		...
		<div class="container">
		   ...
		   <ul class="shopCategory">
		   		<li class="list selected"><a class="btn" href="${pageContext.request.contextPath}/shop/list.do">Whole Item(전체상품)</a></li>
		   		<li class="list"><a class="btn" href="${pageContext.request.contextPath}/shop/list.do?category=food">Dry Food(사료)</a></li>
			   	<li class="list"><a class="btn" href="${pageContext.request.contextPath}/shop/list.do?category=snack">Snack(간식)</a></li>
			   	<li class="list"><a class="btn" href="${pageContext.request.contextPath}/shop/list.do?category=toy">Toy(장난감)</a></li>	  
		   </ul>
		   <div class="row">
